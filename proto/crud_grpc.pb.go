...
const (
	ItemService_CreateItem_FullMethodName = "/crud.ItemService/CreateItem"
	ItemService_GetItem_FullMethodName    = "/crud.ItemService/GetItem"
)
